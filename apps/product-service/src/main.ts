...
app.get('/health', (req, res) => {
  res.status(200).send('Product Service running successfully!');
});
...
const server = app.listen(port, () => {
  console.log(`Product service is running at ${host}:${port}/api`);
  console.log(`Product service Swagger Docs available at ${host}:${port}/docs-json`);
});
