...
const Signup = () => {
  ...
  return (
    <div className='flex min-h-screen flex-col items-center pt-10'>
      {/* Stepper */}
      <div className='relative mb-8 flex items-center justify-between md:w-[50%]'>
        <div className='absolute left-0 top-[25%] -z-10 h-1 w-[80%] bg-gray-300 md:w-[90%]' />
        {[1, 2, 3].map((step) => (
          <div key={step}>
            <div
              className={`flex h-10 w-10 items-center justify-center rounded-full font-bold text-white ${step <= activeStep ? 'bg-blue-600' : 'bg-gray-300'}`}
            >
              {step}
            </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  ...
                  {...register('phone_number', {
                    ...
                    minLength: {
                      value: 10,
                      message: 'Phone must be atleast 10 digits',
                    },
                    maxLength: {
                      value: 15,
                ...
                {signupMutation.isError &&
                  signupMutation.error instanceof AxiosError && (
                    <p className='mt-2 text-sm text-red-500'>
                      {typeof signupMutation.error.response?.data ===
                        'object' &&
                      signupMutation.error.response?.data &&
                      'message' in signupMutation.error.response.data
                        ? (
